...
// export default function Sens_Stat({ type }) {
//   const [chartData, setChartData] = useState([]);

//   const typeToUrlMap = {
//     FreshMeat: "http://3.38.52.82/meat/statistic?type=6",
//     ProcMeat: "http://3.38.52.82/meat/statistic?type=7",
//     HeatedMeat: "http://3.38.52.82/meat/statistic?type=8",
//   };

//   const fetchData = async () => {
//     try {
//       const response = await fetch(typeToUrlMap[type]);
